...
def lastp(expiry,logid,Name,Father,Mother,Phone,Email,Address,Gender,passc,new_pas1,birthdate,Account_Created,account_num,card_num,ifsc_code,cvv,City,Country,branch_code,Pan,Aadhar,Passport,Voter,Occupation,Organization,Income,Net_Worth,Qualification):
    ...
    demodb.commit() 
    democursor=demodb.cursor()
    democursor.execute("create table bal_"+account_num+" (date_t date,current_bal varchar(50))")
    demodb.commit() 
    democursor=demodb.cursor()
    ...
    demodb.commit()
    democursor=demodb.cursor()
    democursor.execute("insert into bal_"+account_num+" values(%s,%s)",(Account_Created,"0"))
    demodb.commit()
...
###############################################################################
                    ...
                    for i in democursor:
                        date_ll=i[0]
                        time_ll=i[1]
                    democursor.execute("Select * from Bal_"+cd+"")
                    for i in democursor:
                        curr_bal=i[1]
                        date_l_b=i[0]
...
Phone - +918799523738""")
                    ...
                    l=Label(c,text="Current Balance : "+new_f+" Cr.",fg='red',bg='white',font="LUCIDA 15 bold").pack(padx=0,pady=0)
                    ...
                    def ft():
                        ...
                        l=Label(t,text=new_f+" Cr.",fg='green',bg='thistle3',font="LUCIDA 25 bold").place(x=1340,y=750)
                        ...
                        if num_trans==0:
                            ...
                            if num_trans==1:
                                ...
                                def setamt():
                                    ...
                                    from_ac.set(cd)
                                    name_to.set(namest4)
                                l=Button(t,text=to_ac4+"     Rs."+amout4+"      "+tarikh4+"   "+date_samay4,activeforeground='green',width=35,relief='solid',bg='thistle3',fg='green',activebackground='thistle3',borderwidth=5,command=setamt,font="LUCIDA 16 bold").place(x=1150,y=180)
                                ...
                                def setamt():
                                    ...
                                    from_ac.set(cd)
                                    name_to.set(namest3)
                                l=Button(t,text=to_ac3+"     Rs."+amout3+"      "+tarikh3+"    "+date_samay3,activeforeground='green',width=35,relief='solid',bg='thistle3',fg='green',activebackground='thistle3',borderwidth=5,command=setamt,font="LUCIDA 16 bold").place(x=1150,y=240)
                                ...
                                l=Button(t,text=to_ac2+"     Rs."+amout2+"      "+tarikh2+"    "+date_samay2,activeforeground='green',width=35,relief='solid',bg='thistle3',fg='green',activebackground='thistle3',borderwidth=5,command=setamt,font="LUCIDA 16 bold").place(x=1150,y=300)
                                for i in democursor:
                                    to_ac1=i[0]
                                    amout=i[1]
                                    rema=i[4]
                                ...
                                def setamt():
                                    ...
                                    from_ac.set(cd)
                                    name_to.set(namest)
                                l=Button(t,text=to_ac1+"     Rs."+amout+"      "+tarikh+"    "+date_samay,activeforeground='green',width=35,relief='solid',bg='thistle3',fg='green',activebackground='thistle3',borderwidth=5,command=setamt,font="LUCIDA 16 bold").place(x=1150,y=360)
                            
                                #l=Label(t,text="Rs."+amout,bg='thistle3',fg='green',font="LUCIDA 15 bold").place(x=1270,y=150)
                                #l=Label(t,text=tarikh,bg='thistle3',fg='green',font="LUCIDA 15 bold").place(x=1420,y=150)
                                #l=Label(t,text=date_samay,bg='thistle3',fg='green',font="LUCIDA 15 bold").place(x=1570,y=150)
                        def proceed():
                            to_ac1=to_ac.get()
                            amt1=amt.get()
                            ...
                            if to_ac1=="" or amt1=="" or remarks1=="" or from_ac1=="" or name_to1=="" or to_ac1==" " or amt1==" " or remarks1==" " or from_ac1==" " or name_to1==" " or amt_val==1:
                                ...
                                def next_pro():
                                    ...
                                    if tick1==0:
                                        ...
                                        b=Button(o,text="Proceed",bg='white',borderwidth=1,activebackground='white',relief='solid',command=None,font='LUCIDA 15').place(x=400,y=50)
                                b=Checkbutton(o,text="Are You Sure You Want to Transfer Rs."+amt1+" to "+name_to1,bg='white',activebackground='white',command=next_pro,variable=tick,onvalue=1,offvalue=0,font="LUCIDA 15").pack(padx=0,pady=0)        
